...
/*function EventListenerReturn OnRankUp(Object EventData, Object EventSource, XComGameState NewGameState, Name InEventID, Object CallbackData)
{
	`log("RankedUp!");
...
static function GCValidationChecks() //Thanks Amineri and LWS
{
    ...
    `LOG("SWP: Starting Garbage Collection and Validation.");
    ...
    foreach History.IterateByClassType(class'XComGameState_SecondWavePlus_UnitComponent',SWPCState,,true)
    {
        ...
        if(SWPCState.OwningObjectId > 0)
        {
            ...
            else
            {
                ...
                {
                    `LOG("SWP: Owning Unit was removed, Removing SWPCState");
                    NewGameState.RemoveStateObject(SWPCState.ObjectID);
                }
            }
        }
